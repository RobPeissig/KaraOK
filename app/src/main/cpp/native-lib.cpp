...
Java_com_example_karaok_NativeInterface_createAudioEngine(
        JNIEnv,
        jobject /* this */) {
    enginePtr = new DuplexEngine();
}
JNIEXPORT void JNICALL
Java_com_example_karaok_NativeInterface_destroyAudioEngine(
        JNIEnv,
        jobject /* this */) {
    if (!enginePtr) return;
    delete enginePtr;
...
Java_com_example_karaok_NativeInterface_getEffects(JNIEnv *env, jobject) {
    jclass jcl = env->FindClass("com/example/karaok/datatype/EffectDescription");
    jclass jparamcl = env->FindClass("com/example/karaok/datatype/ParamDescription");
    ...
    auto jMethodId = env->GetMethodID(jcl, "<init>",
                                      "(Ljava/lang/String;Ljava/lang/String;I[Lcom/example/karaok/datatype/ParamDescription;)V");
...
JNIEXPORT void JNICALL
Java_com_example_karaok_NativeInterface_addDefaultEffectNative(JNIEnv *, jobject, jint jid) {
    if (!enginePtr) return;
...
JNIEXPORT void JNICALL
Java_com_example_karaok_NativeInterface_removeEffectNative(JNIEnv *, jobject, jint jind) {
    if (!enginePtr) return;
...
JNIEXPORT void JNICALL
Java_com_example_karaok_NativeInterface_rotateEffectNative(JNIEnv *, jobject,
                                                                jint jfrom, jint jto) {
    if (!enginePtr) return;
...
JNIEXPORT void JNICALL
Java_com_example_karaok_NativeInterface_modifyEffectNative(
...
JNIEXPORT void JNICALL
Java_com_example_karaok_NativeInterface_enableEffectNative(
...
JNIEXPORT void JNICALL
Java_com_example_karaok_NativeInterface_enablePassthroughNative(
