...
import com.example.karaok.databinding.FxActivityMainBinding
import com.example.karaok.datatype.Effect

class FXMainActivity : AppCompatActivity() {

    private var TAG: String = this.toString()
    lateinit var binding: FxActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.fx_activity_main)
